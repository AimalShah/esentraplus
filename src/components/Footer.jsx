...
const footerLinks = [
  ...
  { label: "Contact", items: ["Help Center", "Shipping", "Returns", "hello@ritualstudio.com"] },
];

export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[#D8D0C4] text-[#1C1A16]">
