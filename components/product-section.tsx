      ...
      <div className="group p-2 md:min-h-[28rem] w-full bg-white rounded-2xl md:w-80 flex flex-col gap-4 cursor-pointer hover:shadow-lg transition-shadow duration-300">
        ...
        <div className="px-2 pb-2 flex-1 flex flex-col">
          ...
          <p className="text-gray-600 font-sans text-sm line-clamp-2 mt-1">
            {product.short_description?.replace(/<[^>]*>/g, '') || 'Premium skincare product'}
          </p>
  ...
  return [
    {
      ...
      short_description: 'Silky cream for instant hydration and overnight skin repair.',
      sku: 'NC001',
      price: '3500',
      regular_price: '4000',
      sale_price: '3500',
    ...
    },
    {
      ...
      short_description: 'A glow-enhancing serum infused with vitamin C for radiant skin.',
      sku: 'GS001',
      price: '5500',
      regular_price: '5500',
      sale_price: '',
    ...
    },
    {
      ...
      short_description: 'Gentle hydrating cleanser for daily skincare routine.',
      sku: 'HC001',
      price: '2800',
      regular_price: '3200',
      sale_price: '2800',
      ...
      images: [{
        ...
        date_created: '',
        date_modified: '',
        src: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=500&q=80',
        name: 'Hydrating Cleanser',
        alt: 'Hydrating Cleanser Product'
      }],
      attributes: [],
      default_attributes: [],
      variations: [],
    ...
    },
    {
      ...
      short_description: 'Brightening daily moisturizer enriched with vitamin C.',
      sku: 'VCM001',
      price: '4200',
      regular_price: '4200',
      sale_price: '',
      ...
      images: [{
        ...
        name: 'Vitamin C Moisturizer',
        alt: 'Vitamin C Moisturizer Product'
      }],
      attributes: [],
      default_attributes: [],
      variations: [],
